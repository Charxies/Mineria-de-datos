...
dfclust["valence"] = df["valence"]
dfclust["danceability"] = df["danceability"]
dfclust["explicit"] = df["explicit"]



scatter_group_by("P8_con_clasificacion.jpg", dfclust, "valence", "danceability", "explicit")
list_t = [
